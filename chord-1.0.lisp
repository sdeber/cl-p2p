...
(defclass chord-node ()
  ((fingertable :accessor get-fingertable
   ...
   (status :accessor get-status
	   :initform :offline)
   (stablize-timer :accessor get-timer)
